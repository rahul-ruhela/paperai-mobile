...
export const HomeStyles = StyleSheet.create({
    ...
    tabActive: {
        backgroundColor: "rgba(165,180,252,0.92)",
    ...
    highlight: { backgroundColor: "rgba(165,180,252,0.28)", borderRadius: 6 },
    ...
    emptyBtn: {
        ...
        alignItems: "center",
        gap: 10,
        backgroundColor: "rgba(165,180,252,0.95)",
        paddingHorizontal: 14,
        paddingVertical: 10,
        borderRadius: 14,
    },
    emptyBtnText: { color: "#0B1220", fontWeight: "950", fontSize: 13 },
    ...
    sheetTitle: { flex: 1, fontWeight: "950", fontSize: 15, color: "#0B1220" },
    sheetAction: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 14 },
    sheetText: { fontSize: 15, fontWeight: "900", color: "#0B1220" },
    ...
    aiText: { flex: 1, fontSize: 13, fontWeight: "700", color: "#0B1220" },
    ...
    fab: {
        ...
        zIndex: 50,
        elevation: 20,
        backgroundColor: "rgba(165,180,252,0.98)",
        borderRadius: 999,
        paddingHorizontal: 14,
        paddingVertical: 10,
        flexDirection: "row",
    ...
    fabText: { color: "#0B1220", fontWeight: "950", fontSize: 13 },
});
