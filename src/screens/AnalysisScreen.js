                    ...
                    <ScrollView contentContainerStyle={styles.container}>
                        ...
                        {doc?.status === "PROCESSED" && (
                            <>
                                ...
                                {/* Smart Reminders — renders nothing when no
                                    actionable date is detected. */}
                                ...
                                {/* Hidden while chat runs against the stub. Shipping a
                                    ...
                                    App Review 2.1 rejection — same reason the OCR AI actions
                                    in UploadScreen stay commented out. Flip USE_STUB to false
                                    in src/api/chat.js the moment the endpoint is live and this
